...
(function () {
  ...
  const translations = {
    en: {
      ...
      menswear: "Menswear",
      mensTshirt: "Men’s Casual T-Shirt",
      mensTshirtText: "An everyday knitwear format for private-label collections.",
      streetwear: "Streetwear",
      hoodie: "Streetwear Hoodie",
      hoodieText: "A casualwear product requiring structured fit and finishing.",
      ...
      altTshirt: "Temporary placeholder for future photograph of a men’s casual T-shirt",
      altHoodie: "Temporary placeholder for future photograph of a streetwear hoodie",
    ...
    tr: {
      ...
      mensTshirt: "Erkek Günlük Tişört",
      mensTshirtText: "Özel markalı koleksiyonlara uygun günlük bir örme giyim ürünü.",
      streetwear: "Sokak Modası",
      hoodie: "Sokak Modası Kapüşonlu Sweatshirt",
      hoodieText: "Yapılandırılmış kalıp ve temiz bitiş gerektiren günlük bir giyim ürünü.",
      ...
      altTshirt: "Gelecekte eklenecek erkek günlük tişört fotoğrafı için geçici alan",
      altHoodie: "Gelecekte eklenecek kapüşonlu sokak modası ürünü fotoğrafı için geçici alan",
